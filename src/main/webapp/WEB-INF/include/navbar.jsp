...
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom sticky-top shadow-sm py-2">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <%-- Thanh tìm kiếm (Đã được chuẩn hóa thành Form gửi tới /product/search) --%>
            ...
            <form action="${pageContext.request.contextPath}/product/search" method="GET" class="dropdown" id="searchDropdownContainer">
                <div class="position-relative" data-bs-toggle="dropdown" aria-expanded="false" style="cursor: pointer;">
                    <input type="text" class="form-control bg-light border-0 ps-5 py-2 text-sm" 
                           ...
                           name="keyword"
                           value="${param.keyword}"
                           data-vi-placeholder="Tìm kiếm máy tính, phụ kiện..." 
                           data-en-placeholder="Search laptops, accessories..." 
                    ...
                    <ul class="list-unstyled mb-0 d-flex flex-column gap-1">
                        <li>
                            <a href="${pageContext.request.contextPath}/product/search?keyword=Âm%20thanh" class="d-flex align-items-center gap-3 text-decoration-none text-dark p-2 search-item">
                                ...
                                <span class="fw-semibold text-uppercase text-muted" style="letter-spacing: 0.5px; font-size: 13px;">Âm thanh đỉnh cao</span>
                            </a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/product/search?keyword=Máy%20chơi%20game" class="d-flex align-items-center gap-3 text-decoration-none text-dark p-2 search-item">
                                ...
                                <span class="fw-semibold text-uppercase text-muted" style="letter-spacing: 0.5px; font-size: 13px;">Máy chơi game & Kính thực tế ảo</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="d-flex align-items-center gap-4">
            ...
            <div class="btn-group border rounded bg-light p-0.5" role="group">
                <button id="btn-vi" onclick="switchLanguage('vi')" class="btn btn-sm fw-bold py-0.5 px-2 transition bg-transparent border-0">VN</button>
                <button id="btn-en" onclick="switchLanguage('en')" class="btn btn-sm fw-bold py-0.5 px-2 text-muted transition bg-transparent border-0">ENG</button>
            </div>

            <%-- Giỏ hàng (Đã sửa dứt điểm lỗi thẻ đóng cắt cụt HTML) --%>
            <a href="${pageContext.request.contextPath}/cart" class="text-dark position-relative text-decoration-none">
            ...
            <%-- Nút đăng nhập --%>
            <a href="${pageContext.request.contextPath}/login" class="btn text-white px-4 py-2 text-sm" style="background-color: #0056b3; border-radius: 8px; text-decoration: none;">
